...
export const ClubService = {
    getClubByIdOrSlug: function (slugOrId: SlugOrId ): Promise<Club | null> | null {
        if ("id" in slugOrId) {
    ...
    create: async function ({ name, country, userId }: ClubCreate & UserIdObject): Promise<Club | null> {
