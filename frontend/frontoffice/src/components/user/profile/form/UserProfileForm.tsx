        ...
        <form onSubmit={form.onSubmit(onSubmit)}>
            ...
            <Stack gap={"md"}>
                <Stack>
                    ...
                    <Flex gap="sm">
                        <Select data={Object.values(NationalId)} label={"nationalIdType"} {...form.getInputProps("nationalIdType")} />
                        <TextInput label={"nationalId"} {...form.getInputProps("nationalId")} />
                    </Flex>
                    <TextInput type="date" label={"dateOfBirth"} {...form.getInputProps("dateOfBirth")} />
                </Stack>
